...
export default function Footer() {
  ...
  return (
    <footer className="bg-sand/50 border-t border-sand">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-serif font-semibold text-charcoal text-base uppercase tracking-widest mb-5">
              Quick Links
            </h4>
            <ul className="space-y-3">
              {(
                ...
                <li key={item}>
                  <Link
                    to="/"
                    className="font-sans text-sm text-soft-gray hover:text-gold transition-colors"
                  >
                    {item}
                  </Link>
                </li>
